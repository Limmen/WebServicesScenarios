 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://flight_reservation}priceEntry" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetPriceListResponse {
    ...
    protected List<PriceEntry> _return;
     ...
     * 
     */
    public List<PriceEntry> getReturn() {
        if (_return == null) {
            _return = new ArrayList<PriceEntry>();
        }
        return this._return;
    }
